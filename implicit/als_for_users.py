""" Implicit Alternating Least Squares For Users"""
import itertools
import logging
import time
...
class AlternatingLeastSquaresForUsers(RecommenderBase):
    def __init__(self, item_factors, factors=100, regularization=0.01, dtype=np.float64,
